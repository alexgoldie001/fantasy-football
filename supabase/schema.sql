...
create table public.scoring_rules (
  ...
  goal_gk integer not null default 6,
  goal_def integer not null default 6,
  ...
  defensive_contribution integer not null default 2,
  goals_conceded_per_two integer not null default -1,
