...
type PlayerData = { season:string; player:{ web_name:string; team_name:string; position:string }; points:number; weeks:{ gameweek:number; date:string; points:number; goals:number; assists:number; cleanSheets:number }[] };
